# Классификация товара (Соревнование от компании Казань-Экспресс)
...
- **Разработан и реализован с нуля метод поэтапной иерархической классификации, который уменьшил время обучения всего до 4 минут, при потреблении памяти не более 3 Гб (Хотя на "плоской" классификации не хватало даже 12.7 Гб памяти в Google Colab, что приводило к падению ядра)**
