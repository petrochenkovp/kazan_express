...
- **Разработан и реализован с нуля метод поэтапной иерархической классификации, который уменьшил время обучения всего до 4 минут, при потреблении памяти не более 3 Гб, хотя на "плоской" классификации падало ядро даже в Google Colab**
